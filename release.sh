#!/bin/bash
# =============================================================================
#  release.sh — Script de compilación de APK para Nuba
# =============================================================================
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  🚀 Nuba Release Builder (LOCAL)"
...
APK_NAME="NUBA-ANDROID-V${FINAL_NAME}.apk"
LOCAL_OUT="$SCRIPT_DIR/$APK_NAME"

echo ""
echo "🔨 Iniciando compilación LOCAL..."
echo "Comando: npx eas-cli build --platform android --profile preview --local"
echo ""
